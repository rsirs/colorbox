...
export class Color {
        ...
        if (typeof value === "string") {
            if (value.match(regex)) {
                ...
                this._rgb = {
                    ...
                    b: parseInt(value.substring(5), 16),
                };
    ...
    alpha(value) {
        ...
        const hexAlpha = Math.round(value * 255).toString(16).padStart(2, "0");
    ...
    */
    ...
    setLuminance(luminance) {
        const hsl = this.hsl;
        hsl.l = luminance;
        console.log(this.toString(), this.this.hslToHslString(hsl));
    ...
    toHslString() {
        return hslToHslString(this.hsl)
    }
